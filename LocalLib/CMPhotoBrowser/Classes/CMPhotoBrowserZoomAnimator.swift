//
//  CMPhotoBrowserZoomAnimator.swift
//  CMVideoPhotoDemo
//
...
class CMPhotoBrowserZoomAnimator: NSObject, CMPhotoBrowserAnimatedTransitioning {
    ...
    /// 转场动画的前向视图
    var previousViewProvider: PreviousViewAtIndexClosure = { _ in return nil }
    
    /// 替补的动画方案
    lazy var substituteAnimator: CMPhotoBrowserAnimatedTransitioning = CMPhotoBrowserFadeAnimator()
    
    init(previousView: @escaping PreviousViewAtIndexClosure) {
    ...
    private func snapshotsAndFrames(browser: CMPhotoBrowser) -> (UIView, UIView, CGRect, CGRect)? {
...
//            CMPhotoBrowserLog.high("取不到前截图！")
//            return nil
//        }
//        guard let snap2 = snapshot(with: cell.showContentView) else {
//            CMPhotoBrowserLog.high("取不到后截图！")
//            return nil
//        }
